...
Nb.prototype.log = function(a, b, c) {
  if (a.value >= Ub(this).value) {
    for (ea(b) && (b = b()), a = new Lb(a, String(b), this.f), c && (a.a = c), c = "log:" + a.b, l.console && (l.console.timeStamp ? l.console.timeStamp(c) : l.console.markTimeline && l.console.markTimeline(c)), l.msWriteProfilerMark && l.msWriteProfilerMark(c), c = this;c;) {
      c = c.a;
    }
  }
};
...
function mc(a, b, c, e) {
  for (var d = 0;d < a.length;++d) {
    var f = a[d];
    if (!f.Z && f.listener == b && f.pa == !!c && f.ua == e) {
      return d;
    }
  }
  return -1;
...
Ic.prototype.i = function() {
  if (this.f) {
    var a = r() - this.h;
    0 < a && a < .8 * this.c ? this.a = this.b.setTimeout(this.g, this.c - a) : (this.a && (this.b.clearTimeout(this.a), this.a = null), R(this, Jc), this.f && (this.a = this.b.setTimeout(this.g, this.c), this.h = r()));
  }
};
function Kc(a) {
  a.f = !0;
...
function S(a) {
  ...
  this.g = 0;
  this.h = "";
  this.f = this.Ga = this.I = this.Fa = !1;
  this.i = 0;
  this.Ca = null;
  this.Wa = Tc;
  this.Da = this.Xa = !1;
...
t(S, Q);
var Tc = "";
S.prototype.b = Yb("goog.net.XhrIo");
var Uc = /^https?$/i, Vc = ["POST", "PUT"];
function Wc(a, b, c, e, d) {
  if (a.a) {
    throw Error("[goog.net.XhrIo] Object is active with another request=" + a.wa + "; newUri=" + b);
  }
  ...
  a.Fa = !1;
  a.c = !0;
  a.a = a.na ? Sc(a.na) : Sc(Qc);
  a.Ea = a.na ? Oc(a.na) : Oc(Qc);
  a.a.onreadystatechange = q(a.Va, a);
  try {
    L(a.b, T(a, "Opening Xhr")), a.Ga = !0, a.a.open(c, String(b), !0), a.Ga = !1;
  } catch (f) {
  ...
  !(0 <= Ha(Vc, c)) || d || e || x(k, "Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
  k.forEach(function(a, b) {
    this.a.setRequestHeader(b, a);
  }, a);
  a.Wa && (a.a.responseType = a.Wa);
  "withCredentials" in a.a && (a.a.withCredentials = a.Xa);
  try {
    Yc(a), 0 < a.i && (a.Da = Zc(a.a), L(a.b, T(a, "Will abort after " + a.i + "ms if incomplete, xhr2 " + a.Da)), a.Da ? (a.a.timeout = a.i, a.a.ontimeout = q(a.Ta, a)) : a.Ca = Mc(a.Ta, a.i, a)), L(a.b, T(a, "Sending request")), a.I = !0, a.a.send(b), a.I = !1;
  } catch (h) {
    L(a.b, T(a, "Send error: " + h.message)), Xc(a, h);
  }
}
function Zc(a) {
...
S.prototype.Ta = function() {
  "undefined" != typeof aa && this.a && (this.h = "Timed out after " + this.i + "ms, aborting", this.g = 8, L(this.b, T(this, this.h)), R(this, "timeout"), $c(this, 8));
};
function Xc(a, b) {
  a.c = !1;
...
function ad(a) {
  a.Fa || (a.Fa = !0, R(a, "complete"), R(a, "error"));
}
function $c(a, b) {
  a.a && a.c && (L(a.b, T(a, "Aborting")), a.c = !1, a.f = !0, a.a.abort(), a.f = !1, a.g = b || 7, R(a, "complete"), R(a, "abort"), bd(a));
}
S.prototype.C = function() {
  this.a && (this.c && (this.c = !1, this.f = !0, this.a.abort(), this.f = !1), bd(this, !0));
  S.$.C.call(this);
};
S.prototype.Va = function() {
  this.l || (this.Ga || this.I || this.f ? cd(this) : this.ub());
};
...
function Yc(a) {
  ...
  "number" == typeof a.Ca && (l.clearTimeout(a.Ca), a.Ca = null);
}
function U(a) {
...
t(gd, O);
var hd = [];
gd.prototype.va = function(a, b, c, e) {
  n(b) || (b && (hd[0] = b.toString()), b = hd);
...
gd.prototype.Qa = function(a, b, c, e, d) {
  if (n(b)) {
    for (var f = 0;f < b.length;f++) {
      this.Qa(a, b[f], c, e, d);
    }
  } else {
    c = c || this.handleEvent, d = d || this.b || this, c = xc(c), e = !!e, b = a && a[gc] ? oc(a.L, String(b), c, e, d) : a ? (a = yc(a)) ? oc(a, b, c, e, d) : null : null, b && (Dc(b), delete this.a[b.bb]);
  }
  return this;
};
function id(a) {
...
jd.prototype.C = function() {
  jd.$.C.call(this);
  this.a && (l.clearTimeout(this.a), this.a = null, this.b = !1);
};
jd.prototype.i = function() {
  this.a = null;
  this.b && (this.b = !1, kd(this));
};
function kd(a) {
  a.a = Mc(a.c, a.g);
  a.h.call(a.f);
...
function sd(a, b) {
  ...
  gb(a.w, "t", a.f);
  a.ma = 0;
  a.o = a.b.Ia(a.b.Aa() ? b : null);
  0 < a.Oa && (a.xa = new jd(q(a.rb, a, a.o), a.Oa));
  a.h.va(a.o, "readystatechange", a.Eb);
  var c;
  if (a.W) {
    c = a.W;
    var e = {}, d;
  ...
  a.Y ? (a.ba = "POST", c["Content-Type"] = "application/x-www-form-urlencoded", Wc(a.o, a.w, a.ba, a.Y, c)) : (a.ba = "GET", a.pb && !Fb && (c.Connection = "close"), Wc(a.o, a.w, a.ba, null, c));
  a.b.F(vd);
  if (e = a.Y) {
...
g.Eb = function(a) {
  a = a.target;
  var b = this.xa;
  b && 3 == U(a) ? (M(this.a, "Throttling readystatechange."), b.a ? b.b = !0 : kd(b)) : this.rb(a);
};
g.rb = function(a) {
  try {
    if (a == this.o) {
      a: {
        var b = U(this.o), c = this.o.g, e = dd(this.o);
        if (G && !(10 <= J) || Fb && !H("420+")) {
          if (4 > b) {
            break a;
          }
        } else {
          if (3 > b || 3 == b && !Cb && !ed(this.o)) {
            break a;
          }
        }
        this.R || 4 != b || 7 == c || (8 == c || 0 >= e ? this.b.F(wd) : this.b.F(xd));
        yd(this);
        var d = dd(this.o);
        this.ha = d;
        var f = ed(this.o);
        ...
        if (this.B) {
          4 == b && zd(this), this.I ? (Ad(this, b, f), Cb && this.B && 3 == b && (this.h.va(this.l, Jc, this.Db), Kc(this.l))) : ($b(this.a, this.c, f, null), Bd(this, f)), this.B && !this.R && (4 == b ? this.b.ka(this) : (this.B = !1, ud(this)));
        } else {
    ...
    M(this.a, "Failed call to OnXmlHttpReadyStateChanged_"), this.o && ed(this.o) ? N(this.a, v, "ResponseText: " + ed(this.o)) : N(this.a, v, "No response text");
  } finally {
  }
};
function Ad(a, b, c) {
  for (var e = !0;!a.R && a.ma < c.length;) {
    ...
    if (d == qd) {
      ...
      if (d == pd) {
        ...
        $b(a.a, a.c, d, null), Bd(a, d);
      }
    }
  }
  4 == b && 0 == c.length && (a.P = 1, W(), e = !1);
  a.B = a.B && e;
  e || ($b(a.a, a.c, c, "[Invalid Chunked Response]"), zd(a), Cd(a));
}
g.Db = function() {
  var a = U(this.o), b = ed(this.o);
  this.ma < b.length && (yd(this), Ad(this, a, b), this.B && 4 != a && ud(this));
};
function Dd(a, b) {
...
function Ed(a, b) {
  ...
  a.G.write(yb(c));
  a.G.close();
  a.G.parentWindow.m = q(a.Bb, a);
  a.G.parentWindow.d = q(a.nb, a, !0);
  a.G.parentWindow.rpcClose = q(a.nb, a, !1);
  c = a.G.createElement("DIV");
  a.G.parentWindow.document.body.appendChild(c);
  d = a.w.toString();
  d instanceof E || (d = d.hb ? d.ab() : String(d), vb.test(d) || (d = "about:invalid#zClosurez"), k = new E, k.a = d, d = k);
...
g.nb = function(a) {
  X(q(this.zb, this, a), 0);
};
g.zb = function(a) {
  this.R || (M(this.a, "TRIDENT TEXT (" + this.c + "): " + a ? "success" : "failure"), zd(this), this.B = a, this.b.ka(this), this.b.F(Fd));
};
function Gd(a) {
  a.R = !0;
  zd(a);
...
g.Cb = function() {
  ...
  var a = r();
  if (0 <= a - this.Sa) {
    this.B && K(this.a.a, "Received watchdog timeout even though request loaded successfully"), M(this.a, "TIMEOUT: " + this.w), 2 != this.aa && this.b.F(wd), zd(this), this.P = 2, W(), Cd(this);
  } else {
    var b = this.a.a;
...
function Jd(a, b, c) {
  ...
  d.onload = function() {
    try {
      M(e, "TestLoadImage: loaded"), Kd(d), c(!0);
    } catch (a) {
      N(e, a);
    }
  };
  d.onerror = function() {
    try {
      M(e, "TestLoadImage: error"), Kd(d), c(!1);
    } catch (a) {
      N(e, a);
    }
  };
  d.onabort = function() {
    try {
      M(e, "TestLoadImage: abort"), Kd(d), c(!1);
    } catch (a) {
      N(e, a);
    }
  };
  d.ontimeout = function() {
    try {
      M(e, "TestLoadImage: timeout"), Kd(d), c(!1);
    } catch (a) {
      N(e, a);
    }
  };
...
g.connect = function(a) {
  ...
  this.qb = r();
  var b = this.a.Za;
  null != b ? (this.ga = b[0], (this.da = b[1]) ? (this.v = 1, Nd(this)) : (this.v = 2, Od(this))) : (gb(a, "MODE", "init"), this.A = new V(this, this.b, void 0, void 0, void 0), this.A.W = this.Ma, td(this.A, a, !1, null, !0), this.v = 0);
};
function Nd(a) {
  var b = Pd(a.a, a.da, "/mail/images/cleardot.gif");
  C(b);
  Id(b.toString(), 5E3, q(a.vb, a), 3, 2E3);
  a.F(vd);
}
g.vb = function(a) {
  if (a) {
...
function Od(a) {
  ...
  var b = a.a.I;
  if (null != b) {
    M(a.b, "TestConnection: skipping stage 2, precomputed result is " + b ? "Buffered" : "Unbuffered"), W(), b ? (W(), Qd(a.a, a, !1)) : (W(), Qd(a.a, a, !0));
  } else {
    if (a.A = new V(a, a.b, void 0, void 0, void 0), a.A.W = a.Ma, b = Rd(a.a, a.ga, a.Na), W(), !G || 10 <= J) {
      gb(b, "TYPE", "xmlhttp"), td(a.A, b, !1, a.ga, !1);
    } else {
      gb(b, "TYPE", "html");
      var c = a.A;
      a = Boolean(a.ga);
...
g.kb = function(a, b) {
  ...
  if (0 == this.v) {
    if (M(this.b, "TestConnection: Got data for stage 1"), b) {
      ...
      M(this.b, "TestConnection: Null responseText"), Sd(this.a, this);
    }
  } else {
    if (2 == this.v) {
      if (this.ya) {
        ...
        if ("11111" == b) {
          if (W(), this.ya = !0, this.ra = r(), c = this.ra - this.qb, !G || 10 <= J || 500 > c) {
            this.V = 200, Gd(this.A), M(this.b, "Test connection succeeded; using streaming connection"), W(), Qd(this.a, this, !0);
          }
        } else {
          W(), this.ra = this.Pa = r(), this.ya = !1;
        }
      }
    }
  }
...
g.ka = function() {
  this.V = this.A.ha;
  if (!this.A.B) {
    M(this.b, "TestConnection: request failed, in state " + this.v), 0 == this.v ? W() : 2 == this.v && W(), Sd(this.a, this);
  } else {
    if (0 == this.v) {
      M(this.b, "TestConnection: request complete for initial check"), this.da ? (this.v = 1, Nd(this)) : (this.v = 2, Od(this));
    } else {
      if (2 == this.v) {
        M(this.b, "TestConnection: request complete for stage 2");
        var a = !1;
        (a = !G || 10 <= J ? this.ya : 200 > this.Pa - this.ra ? !1 : !0) ? (M(this.b, "Test connection succeeded; using streaming connection"), W(), Qd(this.a, this, !0)) : (M(this.b, "Test connection failed; not using streaming"), W(), Qd(this.a, this, !1));
      }
    }
  }
};
...
function de(a) {
  a.s || a.D || (a.D = X(q(a.mb, a), 0), a.U = 0);
}
g.mb = function(a) {
  this.D = null;
  ...
  if (this.b == Ud) {
    ...
    3 == this.b && (a ? fe(this, a) : 0 == this.c.length ? M(this.a, "startForwardChannel_ returned: nothing to send") : this.s ? K(this.a.a, "startForwardChannel_ returned: connection already in progress") : (fe(this), M(this.a, "startForwardChannel_ finished, sent request")));
  }
};
function fe(a, b) {
  var c, e;
  b ? 6 < a.S ? (a.c = a.f.concat(a.c), a.f.length = 0, c = a.ja - 1, e = ee(a)) : (c = b.c, e = b.Y) : (c = a.ja++, e = ee(a));
  var d = a.sa.clone();
  A(d, "SID", a.g);
  A(d, "RID", c);
  A(d, "AID", a.ia);
...
function ge(a) {
  a.j || a.H || (a.h = 1, a.H = X(q(a.lb, a), 0), a.X = 0);
}
function he(a) {
  if (a.j || a.H) {
...
g.lb = function() {
  ...
  ae(this, a);
  if (!G || 10 <= J) {
    A(a, "TYPE", "xmlhttp"), td(this.j, a, !0, this.ta, !1);
  } else {
    A(a, "TYPE", "html");
    var b = this.j, c = Boolean(this.ta);
    b.aa = 3;
    b.J = C(a.clone());
    Ed(b, c);
  }
...
g.kb = function(a, b) {
  if (0 != this.b && (this.j == a || this.s == a)) {
    if (this.O = a.ha, this.s == a && 3 == this.b) {
      ...
      if (this.j == a && ce(this), !/^[\s\xa0]*$/.test(b)) {
        for (c = this.l.parse(b), d = 0;d < c.length;d++) {
          var f = c[d];
          this.ia = f[0];
          f = f[1];
          2 == this.b ? "c" == f[0] ? (this.g = f[1], this.ta = f[2], f = f[3], null != f ? this.S = f : this.S = 6, this.b = 3, this.u && this.u.fb(this), this.Ya = Rd(this, this.ta, this.La), ge(this)) : "stop" == f[0] && Y(this, 7) : 3 == this.b && ("stop" == f[0] ? Y(this, 7) : "noop" != f[0] && this.u && this.u.eb(this, f), this.X = 0);
        }
      }
    }
  }
...
g.yb = function() {
  null != this.T && (this.T = null, Gd(this.j), this.j = null, he(this), W());
};
function ce(a) {
...
g.ka = function(a) {
  ...
  if (0 != this.b) {
    if (a.B) {
      1 == b ? (r(), R(Wd, new Yd(Wd)), de(this), this.f.length = 0) : ge(this);
    } else {
      var c = a.P;
      if (3 == c || 7 == c || 0 == c && 0 < this.O) {
        M(this.a, "Not retrying due to error type");
      } else {
        M(this.a, "Maybe retrying, last error: " + od(c, this.O));
        var e;
        if (e = 1 == b) {
          this.s || this.D ? (K(this.a.a, "Request already in progress"), e = !1) : this.b == Ud || this.U >= (this.qa ? 0 : 2) ? e = !1 : (M(this.a, "Going to retry POST"), this.D = X(q(this.mb, this, a), ie(this, this.U)), this.U++, e = !0);
        }
        if (e || 2 == b && he(this)) {
          return;
        }
...
g.Gb = function(a) {
  a ? (M(this.a, "Successfully pinged google.com"), W()) : (M(this.a, "Failed to ping google.com"), W(), je(this, 8));
};
function je(a, b) {
...
var Z, le;
le = {0:"Ok", 4:"User is logging out", 6:"Unknown session ID", 7:"Stopped by server", 8:"General network error", 2:"Request failed", 9:"Blocked by a network administrator", 5:"No data from server", 10:"Got bad data from the server", 11:"Got a bad response from the server"};
Z = function(a, b) {
  var c, e, d, f, k, h, m, v, w, I, D, fa, nd;
  ...
  d.cb = function(a, b) {
    ...
    c = le[b];
    f = b;
    w.readyState !== Z.CLOSED && fa(Z.CLOSING);
  ...
  d.Ka = function(a, c, d) {
    ...
    if (w.readyState !== Z.CLOSED) {
      return D = null, a = f ? le[f] : "Closed", fa(Z.CLOSED), b.reconnect && 7 !== f && 0 !== f && (k = 6 === f ? 0 : m, clearTimeout(v), v = setTimeout(h, k)), e("onclose", 0, a, c, d), f = null;
    }
  };
  d.eb = function(a, b) {
  ...
  h = function() {
    ...
    e("onconnecting");
    clearTimeout(v);
    w.Fb = D = new Td(b.appVersion, null != k ? k.Za : void 0);
    b.crossDomainXhr && (D.Ba = !0);
    D.u = d;
    ...
    if (b.failFast) {
      ...
      (h.s || h.D) && h.U > (h.qa ? 0 : 2) && (M(h.a, "Retry count " + h.U + " > new maxRetries " + (h.qa ? 0 : 2) + ". Fail immediately!"), h.s ? (Gd(h.s), h.ka(h.s)) : (l.clearTimeout(h.D), h.D = null, Y(h, 2)));
    }
    return D.connect("" + a + "/test", "" + a + "/bind", c, null != k ? k.$a() : void 0, null != k ? k.ia : void 0);
  };
  ...
  this.close = function() {
    ...
    k = null;
    if (w.readyState !== Z.CLOSED) {
      return fa(Z.CLOSING), D.disconnect();
    }
  };
